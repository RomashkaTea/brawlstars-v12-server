...
class BattleResultShowdownMessage(Writer):
    ...
    def encode(self):
        ...
        # Array2 start (Need to check)
        self.writeVint(0)


        # Trophies and Experience Bars Array
        self.writeVint(2) # milestones bars array
        self.writeVint(1) # Ranks Milestones ID
        self.writeVint(brawler_trophies) # brawler trophies
        self.writeVint(brawler_trophies_for_rank) # brawler trophies for rank
        self.writeVint(5) # exp Milestones ID
        self.writeVint(self.player.player_experience) # exp
        self.writeVint(self.player.player_experience) # exp for lvl
