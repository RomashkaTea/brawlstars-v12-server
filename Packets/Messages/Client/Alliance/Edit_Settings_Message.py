...
class Edit_Settings_Message(BSMessageReader):
    ...
    def process(self, crypter):
        # Replacing value   
        DataBase.replaceClubValue(self, self.player.club_low_id, self.clubDescription, self.badgeID, self.clubType, self.requiredTrophies, 0)
        
        # Sending confirmation and updated data
        AllianceEditOkMessage(self.client, self.player).send(crypter)
